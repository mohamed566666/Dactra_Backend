...
namespace Dactra.Migrations
{
    ...
    [Migration("20260509214955_add summary to Medical Reports")]
    partial class addsummarytoMedicalReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dactra.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9362cb3a-d6a8-4aa1-b2c7-9ad29c0e7f45",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e7d2ecb7-1627-4bb0-981d-bc72d2ab11a5",
                            Name = "Doctor",
                            NormalizedName = "DOCTOR"
                        },
                        new
                        {
                            Id = "6e86671f-cacb-4df0-bee9-e71d7ea6fc6b",
                            Name = "Patient",
                            NormalizedName = "PATIENT"
                        },
                        new
                        {
                            Id = "33ed2048-8f87-4ca4-aa7f-60c5b142db99",
            ...
            modelBuilder.Entity("Dactra.Models.MedicineDoseTime", b =>
                {
                    ...
                    b.ToTable("MedicineDoseTimes");
                });

            modelBuilder.Entity("Dactra.Models.MedicineReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dactra.Models.NotificationSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dactra.Models.Notifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dactra.Models.PatientFavoriteServiceProvider", b =>
                {
                    b.Property<int>("PatientId")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("PatientId", "ServiceProviderId");

                    b.HasIndex("ServiceProviderId");

                    b.ToTable("PatientFavoriteServiceProviders");
                });
            ...
            modelBuilder.Entity("Dactra.Models.PrescriptionMedicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dactra.Models.VideoCallSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DoctorJoinedAt")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("EndedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<string>("PatientJoinedAt")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dactra.Models.DoctorProfile", b =>
                {
                    ...
                    b.Property<int?>("OnlineConsultationDurationMinutes")
                        .HasColumnType("int");

                    b.Property<decimal?>("OnlineConsultationPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<TimeSpan?>("OnlineWorkingEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("OnlineWorkingStartTime")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Dactra.Models.MedicalReport", b =>
                {
                    b.HasOne("Dactra.Models.PatientProfile", "PatientProfile")
            ...
            modelBuilder.Entity("Dactra.Models.PatientFavoriteServiceProvider", b =>
                {
                    b.HasOne("Dactra.Models.PatientProfile", "Patient")
                        .WithMany("FavoriteServiceProviders")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dactra.Models.ServiceProviderProfile", "ServiceProvider")
            ...
            modelBuilder.Entity("Dactra.Models.PatientProfile", b =>
                {
                    ...
                    b.Navigation("FavoriteServiceProviders");
