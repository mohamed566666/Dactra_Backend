...
{
    /// <inheritdoc />
    public partial class addQuestionsmodels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuestionAnswers_QuestionAnswers_ParentAnswerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionInterests", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionSaves", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionAnswers_ParentAnswerId",
                table: "QuestionAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionInterests_QuestionId",
                table: "QuestionInterests",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionInterests_UserId",
                table: "QuestionInterests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionSaves_QuestionId",
                table: "QuestionSaves",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionSaves_UserId",
                table: "QuestionSaves",
                column: "UserId");
