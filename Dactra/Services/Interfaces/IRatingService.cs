namespace Dactra.Services.Interfaces
{
    ...
    {
        Task<bool> RateProviderAsync(int patientId, int providerId, int score, string comment);
        Task<decimal> CalculateAverageRatingAsync(int providerId);
        Task<bool> UpdateRatingAsync(int patientId, int providerId, int score, string comment);
